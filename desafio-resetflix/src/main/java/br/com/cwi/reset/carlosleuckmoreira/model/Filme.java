...
public class Filme {
    ...
    public Filme(String nome, LocalDate anoLancamento, String capaFilme, List<Genero> generos, Estudio estudio, Diretor diretor, List<PersonagemAtor> personagens, String resumo) {
        this.nome = nome;
